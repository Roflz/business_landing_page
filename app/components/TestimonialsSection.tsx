          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[1,2].map((i, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="p-8 rounded-2xl shadow-lg flex flex-col items-center bg-[color:var(--theme-bg)]"
  ...
  return (
    <section id="testimonials" className="py-16 bg-[color:var(--theme-bg)] animate-fade-in" style={{ color: 'var(--theme-text)' }}>
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="p-8 rounded-2xl shadow-lg flex flex-col items-center animate-fade-in bg-[color:var(--theme-bg)]" style={{ color: 'var(--theme-text)', border: '1px solid var(--theme-primary)' }}>
          ...
          <div className="p-8 rounded-2xl shadow-lg flex flex-col items-center animate-fade-in delay-150 bg-[color:var(--theme-bg)]" style={{ color: 'var(--theme-text)', border: '1px solid var(--theme-primary)' }}>
