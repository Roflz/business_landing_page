          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {[1,2,3].map((i, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="rounded-2xl shadow-lg overflow-hidden hover:scale-105 hover:shadow-2xl transition-transform flex flex-col bg-[color:var(--theme-bg)]"
                style={{ color: 'var(--theme-text)', border: '1px solid var(--theme-primary)' }}
              >
                ...
                <div className="p-5 flex-1 flex flex-col">
                  ...
                  <p className="mb-4 flex-1" style={{ color: 'var(--theme-secondary)' }}>[Short description of the project.]</p>
  ...
  return (
    <section id="portfolio" className="py-16 bg-[color:var(--theme-bg)] animate-fade-in" style={{ color: 'var(--theme-text)' }}>
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {/* Portfolio Card 1 */}
          <div className="rounded-2xl shadow-lg overflow-hidden hover:scale-105 hover:shadow-2xl transition transform flex flex-col bg-[color:var(--theme-bg)]" style={{ color: 'var(--theme-text)', border: '1px solid var(--theme-primary)' }}>
            <div className="h-40 flex items-center justify-center" style={{ background: 'var(--theme-secondary)', color: 'var(--theme-bg)' }}>
              <span className="text-5xl">🌐</span>
            </div>
            <div className="p-5 flex-1 flex flex-col">
              <h3 className="font-semibold text-lg mb-2" style={{ color: 'var(--theme-primary)' }}>[Project One]</h3>
              <p className="mb-4 flex-1" style={{ color: 'var(--theme-secondary)' }}>[Short description of the first project. Example: 'A modern website for a tech startup.']</p>
              <a href="#" className="font-medium hover:underline" style={{ color: 'var(--theme-primary)' }}>View Project</a>
            </div>
          </div>
          {/* Portfolio Card 2 */}
          <div className="rounded-2xl shadow-lg overflow-hidden hover:scale-105 hover:shadow-2xl transition transform flex flex-col bg-[color:var(--theme-bg)]" style={{ color: 'var(--theme-text)', border: '1px solid var(--theme-primary)' }}>
            ...
            <div className="p-5 flex-1 flex flex-col">
              ...
              <p className="mb-4 flex-1" style={{ color: 'var(--theme-secondary)' }}>[Short description of the second project. Example: 'A business landing page for a local company.']</p>
              <a href="#" className="font-medium hover:underline" style={{ color: 'var(--theme-primary)' }}>View Project</a>
            </div>
          </div>
          {/* Portfolio Card 3 */}
          <div className="rounded-2xl shadow-lg overflow-hidden hover:scale-105 hover:shadow-2xl transition transform flex flex-col bg-[color:var(--theme-bg)]" style={{ color: 'var(--theme-text)', border: '1px solid var(--theme-primary)' }}>
            ...
            <div className="p-5 flex-1 flex flex-col">
              ...
              <p className="mb-4 flex-1" style={{ color: 'var(--theme-secondary)' }}>[Short description of the third project. Example: 'A portfolio site for a creative professional.']</p>
              <a href="#" className="font-medium hover:underline" style={{ color: 'var(--theme-primary)' }}>View Project</a>
            </div>
          </div>
        </div>
